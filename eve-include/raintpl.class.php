...
class RainTPL extends Debug
{
    ...
    /**
     * Path replace is a cool features that replace all relative paths of images (<img src="...">), stylesheet (<link
     * href="...">), script (<script src="...">) and link (<a href="...">) Set true to enable the path replace.
     *
     * @var unknown_type
     */
    ...
    /**
     * Debug mode flag.
     * True: debug mode is used, syntax errors are displayed directly in template. Execution of script is not
     * terminated. False: exception is thrown on found error.
     *
     * @var bool
     */
    static $debug = false;
